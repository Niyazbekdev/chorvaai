<x-app-layout>
    <div class="min-h-screen bg-gray-50 pt-24 pb-12">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Yangi e'lon berish</h1>
                <p class="text-gray-500 text-sm mt-1">Barcha maydonlarni to'ldiring</p>
            </div>
                ...
                <fieldset class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}"
                            ...
                            placeholder="Masalan: Sersut sigir">
    ...
    <script>
        ...
        function filterCities() {
            ...
            const placeholder = new Option(regionId ? 'Tanlang...' : 'Avval viloyatni tanlang', '');
