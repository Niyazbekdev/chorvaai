...
<div class="min-h-screen bg-gray-50 pt-8 pb-16">
    <div class="max-w-xl mx-auto px-4 sm:px-6">
        ...
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Reklama berish</h1>
            <p class="text-sm text-gray-500 mt-1">
                30 kun davomida marketplace sahifasida banneringiz ko'rinadi — <strong>30 000 so'm</strong>
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('banners.store') }}" enctype="multipart/form-data"
            ...
            <div class="bg-white rounded-2xl shadow p-6 space-y-3">
                <h2 class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Banner rasmi</h2>
                <p class="text-xs text-gray-400">Tavsiya etilgan o'lcham: 1200×400 px. JPG, PNG yoki WebP. Maks 4 MB.</p>
                    ...
                    <div class="relative border-2 border-dashed border-gray-300 rounded-xl overflow-hidden hover:border-green-400 transition"
                        ...
                        <template x-if="!preview">
                            <div class="flex flex-col items-center justify-center py-12 text-gray-400">
                                ...
                                <span class="mt-2 text-sm">Rasm tanlash uchun bosing</span>
                            </div>
                        </template>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow p-6 space-y-4">
                <h2 class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Banner ma'lumotlari</h2>
                ...
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" maxlength="100"
                           placeholder="Masalan: Arzon narxda sigirlar — Toshkent"
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">
                        Aloqa (telefon yoki manzil) <span class="text-red-500">*</span>
                    </label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">
                        Havola <span class="text-gray-400 font-normal text-xs">(ixtiyoriy)</span>
                    </label>
            ...
            <div class="bg-green-50 border border-green-200 rounded-2xl p-5 flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600">30 kunlik to'lov</p>
